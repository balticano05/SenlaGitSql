...
public final class StringConst {
    ...
    public static String QUERY_INSERT_USER =
            "INSERT INTO users (email, password, role_id) VALUES " +
                    "(?, ?, ?) RETURNING id";
    public static String QUERY_UPDATE_USER = "UPDATE users SET email = ?, password = ?, role_id = ? WHERE id = ?";
    public static String QUERY_DELETE_USER = "DELETE FROM users WHERE id = ?";
}